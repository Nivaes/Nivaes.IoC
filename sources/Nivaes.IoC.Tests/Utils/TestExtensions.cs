...
namespace Nivaes.IoC.Tests.Utils;
...
public static class TestExtensions
{
    ...
    public static Task<Project> ApplyToProgram(this Project project, string newText)
    {
        return project.ReplacePartOfDocumentAsync("Program.cs", "// place to replace", newText);
    }
